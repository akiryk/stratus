...
function stratus_content_nav( $nav_id ) {
	...
	<?php if ( is_single() ) : // navigation links for single posts ?>
		<?php previous_post_link( '<div class="next-last-link previous-fixed">%link</div>', '<span class="icon-angle-left">' . _x( '', 'Previous post link', 'stratus' ) . '</span>' ); ?>
		...
		<?php next_post_link( '<div class="next-last-link next-fixed">%link</div>', '<span class="icon-angle-right">' . _x( '', 'Previous post link', 'stratus' ) . '</span>' ); ?>
